...
Baixe o App: Instale e configure permissões
Primeira Sincronização: Baixe base de dados local
Verifique GPS: Teste localização em casa
Configure Preferências: Ajuste qualidade de imagem
🏠 Saindo de Casa (Sem Internet)
Ative GPS: Permissões de localização
Abra o App: Interface funciona perfeitamente offline
Verifique Status: Mostra "Modo Offline" na tela
Comece a Explorar: Aponte câmera para casarões
🏛️ Explorando Casarões (Totalmente Offline)
Aponte a Câmera: Para fachadas de casarões
Tire a Foto: Qualidade otimizada para análise
Análise Automática: IA local processa em < 1 segundo
Resultados Detalhados: Estilo, ano, valor histórico
Salvamento Local: Análise fica no histórico offline
📊 Tipos de Análise Offline
...
Conecte à Internet: Wi-Fi ou dados móveis
Sincronização Automática: Upload de análises offline
Refinamento: Análises podem ser melhoradas online
Compartilhamento: Envie descobertas para amigos
...
🐛 Como Reportar Bugs
Descrição Clara: O que você estava tentando fazer?
Passos para Reproduzir: Como reproduzir o problema?
Comportamento Esperado: O que deveria acontecer?
Comportamento Atual: O que está acontecendo?
Dispositivo: Qual dispositivo e sistema operacional?
Screenshots: Imagens do problema (se possível)
📝 Enviar Feedback
